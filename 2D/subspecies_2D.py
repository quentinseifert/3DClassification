...
images = ImageDataGenerator().flow_from_directory('Images', target_size=(320, 240),
                                                  classes=['Buche', 'Douglasie', 'Eiche', 'Fichte', 'Kiefer',
                                                           'Rotbuche', 'Roteiche'],
                                                  batch_size=4000,
...
model = load_model('2D_subspecies_model.h5')
...
#model.save('2D_subspecies_model.h5')
