...
# daten in dataroteich liste einlesen 
...
for (i in 1:length(datalinde)) {
    ...
    datalinde2[[i]] <- datalinde[[i]][-which(datalinde[[i]]$V3<(min(datalinde[[i]]$V3))+1),]
...
for (i in 1:length(dataroteiche)) {
  ...
  dataroteiche2[[i]] <- dataroteiche[[i]][-which(dataroteiche[[i]]$V3<(min(dataroteiche[[i]]$V3))+1),]
...
for (i in 1:length(dataahorn)) {
    ...
    dataahorn2[[i]] <- dataahorn[[i]][-which(dataahorn[[i]]$V3<(min(dataahorn[[i]]$V3))+1),]
...
for (i in 1:length(databuche)) {
    ...
    databuche2[[i]] <- databuche[[i]][-which(databuche[[i]]$V3<(min(databuche[[i]]$V3))+1),]
...
for (i in 1:length(dataeiche)) {
    ...
    dataeiche2[[i]] <- dataeiche[[i]][-which(dataeiche[[i]]$V3<(min(dataeiche[[i]]$V3))+1),]
...
for (i in 1:length(dataesche)) {
    ...
    dataesche2[[i]] <- dataesche[[i]][-which(dataesche[[i]]$V3<(min(dataesche[[i]]$V3))+1),]
...
for (i in 1:length(datahainbuche)) {
    ...
    datahainbuche2[[i]] <- datahainbuche[[i]][-which(datahainbuche[[i]]$V3<(min(datahainbuche[[i]]$V3))+1),]
...
for (i in 1:length(datafichte)) {
    ...
    datafichte2[[i]] <- datafichte[[i]][-which(datafichte[[i]]$V3<(min(datafichte[[i]]$V3))+1),]
...
for (i in 1:length(datakiefer)) {
    ...
    datakiefer2[[i]] <- datakiefer[[i]][-which(datakiefer[[i]]$V3<(min(datakiefer[[i]]$V3))+1),]
...
for (i in 1:length(datadouglasie)) {
    ...
    datadouglasie2[[i]] <- datadouglasie[[i]][-which(datadouglasie[[i]]$V3<(min(datadouglasie[[i]]$V3))+1),]
